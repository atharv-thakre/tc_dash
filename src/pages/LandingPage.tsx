  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 selection:bg-indigo-500 selection:text-white font-sans antialiased relative">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-2 sm:gap-4">
          ...
          <nav className="hidden lg:flex items-center gap-6 xl:gap-8 text-xs font-semibold text-zinc-400">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold text-indigo-400 hover:text-indigo-300 bg-indigo-500/10 hover:bg-indigo-500/15 border border-indigo-500/30 transition-all cursor-pointer whitespace-nowrap"
            >
            ...
            >
              <div className="grid grid-cols-2 gap-2 text-xs font-semibold text-zinc-300">
                ...
                <button
                  ...
                  className="p-2.5 rounded-lg bg-indigo-950/40 hover:bg-indigo-900/50 text-indigo-300 border border-indigo-800/60 text-left flex items-center gap-1.5"
                >
      ...
      <main className="relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-6">
            ...
            >
              <div className="flex flex-wrap items-center justify-center gap-3">
                ...
                {/* 4. Register / Get Started Option */}
                <Magnet magnetStrength={0.3}>
                  <button
                    onClick={() => onNavigate('/signup')}
                    className="flex items-center gap-2 px-6 py-3.5 rounded-xl text-sm font-bold bg-zinc-900/80 border border-zinc-800 text-zinc-300 hover:bg-zinc-800 hover:text-white transition-all cursor-pointer shadow-md"
                  >
        ...
        {/* INTERACTIVE DOCUMENTATION & CODEBASE EXPLORER SECTION */}
        <section id="explorer" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-zinc-800/80">
          <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
            <span className="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider text-indigo-400 bg-indigo-950/60 border border-indigo-800/60">
              Interactive Documentation & Filesystem
            </span>
            <h2 className="text-3xl sm:text-4xl font-black text-white tracking-tight">
              Visual Codebase & Docs Explorer
            </h2>
            <p className="text-sm text-zinc-400">
              Explore the entire repository structure, inspect markdown manuals, read Python SDK implementation source code, and search documentation in real time.
            </p>
          </div>

          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 backdrop-blur-sm overflow-hidden p-6 sm:p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 rounded-xl bg-zinc-950/80 border border-zinc-800/80 space-y-2">
                    ...
                    <p className="text-xs text-zinc-400 leading-relaxed">
                      Expandable directory tree spanning <code className="text-indigo-300 font-mono">api/</code>, <code className="text-indigo-300 font-mono">lib/</code>, <code className="text-indigo-300 font-mono">sdk/</code>, and root LLM context manifests.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-zinc-950/80 border border-zinc-800/80 space-y-2">
                    ...
                    <p className="text-xs text-zinc-400 leading-relaxed">
                      Instant multi-file search across code snippets, API endpoints, error tables, and markdown guides.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-zinc-950/80 border border-zinc-800/80 space-y-2">
                    ...
                    <p className="text-xs text-zinc-400 leading-relaxed">
                      Multi-language code viewer for Markdown, Python, JSON, YAML, SQL, Shell, and raw text.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-zinc-950/80 border border-zinc-800/80 space-y-2">
                    ...
                    <p className="text-xs text-zinc-400 leading-relaxed">
                      Direct raw HTTP file access mounted at <code className="text-amber-300 font-mono">/documents</code>, <code className="text-amber-300 font-mono">/llm.txt</code>, and <code className="text-amber-300 font-mono">/readme.md</code>.
                    </p>
                  </div>
                </div>
              </div>

              <div className="flex flex-col items-center justify-center p-6 rounded-xl bg-gradient-to-br from-indigo-950/40 via-zinc-950 to-zinc-900 border border-indigo-500/20 text-center space-y-4">
                <div className="p-3 rounded-2xl bg-indigo-500/10 border border-indigo-500/30 text-indigo-400">
                  <FolderTree className="w-8 h-8" />
                </div>
                <div className="space-y-1">
                  <h3 className="text-base font-bold text-white">Visual File Explorer</h3>
                  <p className="text-xs text-zinc-400">
                    Browse all markdown documentation, Python SDK modules, and AI context files.
                  </p>
                </div>
                <Magnet magnetStrength={0.25}>
                  <button
                    onClick={() => onNavigate('/documents')}
                    className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-bold bg-indigo-600 hover:bg-indigo-500 text-white shadow-lg shadow-indigo-500/30 transition-all cursor-pointer"
                  >
                    <FolderTree className="w-4 h-4" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 font-semibold">
              ...
              <button onClick={() => onNavigate('/documents')} className="hover:text-indigo-400 cursor-pointer flex items-center gap-1">
